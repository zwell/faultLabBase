...
> 学习者面向的文档规范见 [`docs/README-template.md`](./README.template.md) 和 [`docs/SOLUTION-template.md`](./SOLUTION.template.md)。
...
按 [`README.template.md`](./README.template.md) 编写，必须包含：
...
按 [`SOLUTION.template.md`](./SOLUTION.template.md) 编写，必须包含以下 section（**标题不可更改**，verify 模块通过标题定位内容）：
...
- 场景切换：`FAULTLAB_SCENARIO=scenarios/<tech>/<id>`（相对 `faultlab` 根）。
